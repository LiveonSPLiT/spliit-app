...
CREATE TABLE "UserGroupRelationship" (
    ...
    CONSTRAINT "UserGroupRelationship_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "RecentGroup" ADD CONSTRAINT "RecentGroup_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "UserGroupRelationship"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "StarredGroup" ADD CONSTRAINT "StarredGroup_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "UserGroupRelationship"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ArchivedGroup" ADD CONSTRAINT "ArchivedGroup_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "UserGroupRelationship"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
