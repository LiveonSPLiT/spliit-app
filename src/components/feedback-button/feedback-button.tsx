  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Help keep <strong>SPLiT</strong> free and without ads!
        </p>
      </div>
      ...
      <div className="flex justify-center gap-2">
        ...
        >
          <a href="https://github.com/sponsors/sir-argupta" target="_blank">
            <Heart className="w-4 h-4 mr-2" /> Sponsor us (on GitHub)
          </a>
        </Button>
        <Button asChild variant="secondary">
          <a href={donationUrl} target="_blank">
            <Wallet className="w-4 h-4 mr-2" /> Donate (via UPI)
          </a>
        </Button>
      </div>
    </div>
