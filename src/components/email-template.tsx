        ...
        <Container style={container}>
          <Section style={coverSection}>
            <Section style={imageSection}>
              <Img src="/logo-with-text.png" alt="SPLiT's Logo" />
            </Section>
            <Section style={upperSection}>
              ...
              {isButtonVisible ? (
                <Section style={verificationSection}>
                  ...
                  <Text style={validityText}>({emailButtonFooterText})</Text>
                </Section>
              ) : (
            ...
            <Section style={lowerSection}>
              <Text style={cautionText}>
                SPLit will never email you and ask you to disclose or verify
                your password, credit card, or banking account number.
              </Text>
            </Section>
          </Section>
          <Text style={footerText}>
            This message was produced and distributed by SPLiT App, Pune, MH-IN.
            <br /> © 2024, SPLit. All rights reserved. Visit SPLiT at{' '}
            <Link href="https://liveonsplit.com" target="_blank" style={link}>
              Liveonsplit.com
            </Link>
            . View our{' '}
            <Link
              href="https://liveonsplit.com/legal/privacy-policy"
              target="_blank"
              style={link}
            >
              privacy policy
