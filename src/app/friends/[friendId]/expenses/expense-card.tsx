'use client'
import { ActiveUserBalance } from '@/app/friends/[friendId]/expenses/active-user-balance'
import { CategoryIcon } from '@/app/friends/[friendId]/expenses/category-icon'
import { DocumentsCount } from '@/app/friends/[friendId]/expenses/documents-count'
...
export function ExpenseCard({ expense, currency, groupId }: Props) {
  ...
  return (
    <div
      ...
      onClick={() => {
        router.push(`/friends/${groupId}/expenses/${expense.id}/edit`)
      }}
    >
      <CategoryIcon
      ...
      <Button
        ...
        asChild
      >
        <Link href={`/friends/${groupId}/expenses/${expense.id}/edit`}>
