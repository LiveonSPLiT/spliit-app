...
export default function TermsAndConditions() {
  return (
    <main className="flex-1 w-full max-w-screen-md mx-auto my-8 px-4">
      <div>
        <h1 className="text-4xl font-extrabold mt-4 mb-8">
          Terms & Conditions
        </h1>
        <div className="mb-12 prose dark:prose-invert">
          <div>
            ...
            <p>
              ...
              our bill-splitting SPLiT app (&quot;the App&quot;). By accessing
            ...
            <p>
              ...
              agree not to use the App for any unlawful purpose or in any way
              that could damage the App or its users.
            </p>

            <h2>3. Account Responsibility</h2>
            <p>
              You are responsible for maintaining the confidentiality of your
              account information, including your email and any other
            ...
            <p>
              We only collect your name and email address to facilitate the
              functionality of the App. We do not provide any data restoration,
              backup, or recovery services. You acknowledge and agree that we
              are not liable for any loss of data.
            </p>
            ...
            <p>
              ...
              use, arising out of or in connection with your use of the App.
            </p>
